...
![readme - input example](reference/figures/two_drugs_input_1.png)
...
visualization of results. The [`run_EDITH()`](reference/run_EDITH.md)
...
![readme - output example](reference/figures/two_drugs_output.png)
