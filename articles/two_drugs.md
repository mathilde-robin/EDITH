...
![two drugs - input 1](../reference/figures/two_drugs_input_1.png)
...
![two drugs - input 2](../reference/figures/two_drugs_input_2.png)
...
![two drugs - input 3](../reference/figures/two_drugs_input_3.png)
...
![two drugs - popup](../reference/figures/two_drugs_popup.png)
...
a input file with 2 experiments (ie. 2 excel sheets `line1` and
`line2`), with 2 replicates each:

![two drugs - output dir](../reference/figures/two_drugs_output_dir.png)

  

You obtain:

1.  One `.pdf` file per replicate (ie. per experiment and per
    replicate):
...
3.  One `.xlsx` file per experiment (ie. per excel sheet) detailing the
    additive, combination and efficacy indexes for all replicates.

![two drugs - output
index](../reference/figures/two_drugs_output_index.png)
